...
module.exports={
  ...
  "homepage": "https://github.com/THISISAGOODNAME/cannon.js",
  "author": "Yanjun Yang <yang_yj19931231@163.com> (http://aicdg.com)",
  "keywords": [
    "cannon.js",
    "cannon",
    "physics",
...
/**
 * 计算幽灵方程的分母,幽灵方程: C = G*inv(M)*G' + eps
...
/**
 * 四元数描述三维空间中的旋转.数学描述Q = x*i + y*j + z*k + w,其中(i,j,k)为向量,(x,y,z)为旋转轴,w是真正的乘数,表示旋转的量
...
/**
 * 高度场是一种图形。高度数据给定，数据点均匀分布在给定的范围内
...
/**
 * 设置高度值索引,设置完后要更新maxValue和minValue
